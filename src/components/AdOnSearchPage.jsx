...
//IMAGES
import home_showcase from '../assets/home_showcase.png'
import sbi_logo from '../assets/SBI_logo.png'
...
function AdOnSearchPage() {
  return (
    ...
    <div className="sbi_ad_container">
      <div className="sbi_logo"> <img src={sbi_logo} alt="SBI" /></div>
      ...
      <div className="hands_png"> <img src={home_showcase} alt="home" /></div>
    </div>
